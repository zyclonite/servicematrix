...
class ConnectionsController extends Controller
{
	...
	public function actionCreate()
	{
		$model=new Connections;
                $types=Connectiontypes::model()->findAll();
		...
		{
			$model->attributes=$_POST['Connections'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Connections');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='connections-form')
		{
