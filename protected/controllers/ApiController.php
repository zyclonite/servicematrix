...
class ApiController extends CController {
     ...
     * @return void
     */
    private function _checkAuth($rights = 1)
    {
        // Check for active session (ajax request)
        if(!Yii::app()->user->getIsGuest()) {
            if(Yii::app()->user->getState('rights') >= $rights) {
                return true;
            }
        }
        ...
        if ($identity->getState('rights') < $rights) {
            $this->_sendResponse(403, 'Error: Forbidden');
        }
    }
